...
function e(e, i) {
  ...
  if (
    ...
    !1 === e.ray.intersectSphere(a, o))
  )
    return;
  s.getInverse(this.matrixWorld), r.copy(e.ray).applyMatrix4(s);
...
class s extends t.BufferGeometry {
  ...
  setGeometry(e, i) {
    (this._geometry = e),
      e instanceof t.BufferGeometry
        ? this.setPoints(e.getAttribute('position').array, i)
        : this.setPoints(e, i);
  }
  setPoints(e, i) {
    if (e instanceof Float32Array || e instanceof Array) {
      if (
        ((this._points = e),
        (this.widthCallback = i),
        (this.positions = []),
        (this.counters = []),
        e.length && e[0] instanceof t.Vector3)
      )
        ...
        for (s = 0; s < e.length; s += 3) {
          r = s / e.length;
          this.positions.push(e[s], e[s + 1], e[s + 2]),
            this.positions.push(e[s], e[s + 1], e[s + 2]),
            this.counters.push(r),
            this.counters.push(r);
        }
  ...
  compareV3(t, e) {
    const i = 6 * t,
      s = 6 * e;
    return (
      this.positions[i] === this.positions[s] &&
      this.positions[i + 1] === this.positions[s + 1] &&
      this.positions[i + 2] === this.positions[s + 2]
    );
  }
  copyV3(t) {
    const e = 6 * t;
  ...
  process() {
    ...
    (this.previous = []),
      ...
      (this.indices_array = []),
      (this.uvs = []),
      (s = this.compareV3(0, e - 1) ? this.copyV3(e - 2) : this.copyV3(0)),
      this.previous.push(s[0], s[1], s[2]),
      this.previous.push(s[0], s[1], s[2]);
    for (let t = 0; t < e; t++) {
      if (
        (this.side.push(1),
        ...
        this.width.push(i),
        this.width.push(i),
        this.uvs.push(t / (e - 1), 0),
        this.uvs.push(t / (e - 1), 1),
        t < e - 1)
      ) {
        (s = this.copyV3(t)),
          this.previous.push(s[0], s[1], s[2]),
      ...
      t > 0 &&
        ((s = this.copyV3(t)),
        this.next.push(s[0], s[1], s[2]),
        this.next.push(s[0], s[1], s[2]));
    }
    (s = this.compareV3(e - 1, 0) ? this.copyV3(1) : this.copyV3(e - 1)),
      this.next.push(s[0], s[1], s[2]),
      this.next.push(s[0], s[1], s[2]),
      this._attributes &&
      this._attributes.position.count === this.positions.length
        ...
        : (this._attributes = {
            position: new t.BufferAttribute(
              new Float32Array(this.positions),
              3
            ),
  ...
  constructor(e) {
    super({
      uniforms: Object.assign({}, t.UniformsLib.fog, {
        ...
        alphaMap: { value: null },
        useAlphaMap: { value: 0 },
        color: { value: new t.Color(16777215) },
        opacity: { value: 1 },
        ...
        visibility: { value: 1 },
        alphaTest: { value: 0 },
        repeat: { value: new t.Vector2(1, 1) },
      }),
...
export { s as MeshLine, r as MeshLineMaterial, e as MeshLineRaycast };
